...
public class TunerConstants {
    ...
    public static final CANBus kCANBus = new CANBus("Jerry", "./logs/example.hoot");

    // Theoretical free speed (m/s) at 12 V applied output;
    // This needs to be tuned to your individual robot
    public static final LinearVelocity kSpeedAt12Volts = MetersPerSecond.of(6.05);
    ...
    private static final Angle kFrontLeftEncoderOffset = Rotations.of(-.0542);
    ...
    private static final Angle kFrontRightEncoderOffset = Rotations.of(-.3657 + .5);
    ...
    private static final Angle kBackLeftEncoderOffset = Rotations.of(0.18286);
    ...
    private static final Angle kBackRightEncoderOffset = Rotations.of(-.29126 + .5);
